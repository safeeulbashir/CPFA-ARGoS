...
if __name__ == "__main__":
    ...
    pathForSiteFidelity=sys.argv[13]+"SiteFidelityRecordings/"
    ...
    for file in dirs:
        ...
        #print pathForSiteFidelity
        #if(splitter[1]=="2166759927" || splitter[1]=="917279601"):
        proc=subprocess.Popen(["Rscript", "pyscripts/ChangePointDetector_s.R",saveInto,str(change_points),str(slide_movement),pathForSiteFidelity,str(pile),dirname,str(detrend)])
        #break
