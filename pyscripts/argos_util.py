...
PARAMETER_LIMITS = {
    "RateOfLayingPheromone": (2, 10),
    "RateOfPheromoneDecay": (0, 0.5),
    "ProbabilityOfSwitchingToSearching": (0, 1),
    "RateOfSiteFidelity": (10, 20),
    "RateOfInformedSearchDecay": (0, 20),
    "ProbabilityOfReturningToNest": (0, 0.01),
    "UninformedSearchVariation": (0, 359)
}

def load_xml_default():
    filename ='iAnt.xml' #raw_input('Choose a file name(e.g. cluster_2_mac.argos)')
